...
url = "https://pt.wikipedia.org/wiki/Lista_de_jogos_para_PlayStation_4"  # url da pagina da Wikipedia sobre jogos para PS4
...
dirCSV = "../AT2/Mini-Projeto1/PS4/dataframePS4.csv"  # define o caminho do arquivo csv
df.to_csv(dirCSV, encoding='utf-8', index=False)  # salva o DataFrame em um arquivo csv

dirJSON = "../AT2/Mini-Projeto1/PS4/dataframePS4.json"  # define o caminho do arquivo json
df.to_json(dirJSON, index=False)  # salva o DataFrame em um arquivo json

dirXLSX = "../AT2/Mini-Projeto1/PS4/dataframePS4.xlsx"  # define o caminho do arquivo xlsx
