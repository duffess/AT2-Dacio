...
url = "https://pt.wikipedia.org/wiki/Lista_de_jogos_para_Nintendo_Switch"  # url da pagina da Wikipedia sobre jogos para Nintendo Switch
...
dirCSV = "../AT2/Mini-Projeto1/NINTENDOSWITCH/dataframeNINTENDOSWITCH.csv"  # define o caminho do arquivo csv
df.to_csv(dirCSV, encoding='utf-8', index=False)  # salva o DataFrame em um arquivo csv

dirJSON = "../AT2/Mini-Projeto1/NINTENDOSWITCH/dataframeNINTENDOSWITCH.json"  # define o caminho do arquivo json
df.to_json(dirJSON, index=False)  # salva o DataFrame em um arquivo json

dirXLSX = "../AT2/Mini-Projeto1/NINTENDOSWITCH/dataframeNINTENDOSWITCH.xlsx"  # define o caminho do arquivo xlsx
