...
url = "https://pt.wikipedia.org/wiki/Lista_de_jogos_para_Xbox_360"  # url da pagina da Wikipedia sobre jogos para Xbox 360
...
dirCSV = "../AT2/Mini-Projeto1/XBOX360/dataframeXBOX360.csv"  # define o caminho do arquivo csv
df.to_csv(dirCSV, encoding='utf-8', index=False)  # salva o DataFrame em um arquivo csv

dirJSON = "../AT2/Mini-Projeto1/XBOX360/dataframeXBOX360.json"  # define o caminho do arquivo json
df.to_json(dirJSON, index=False)  # salva o DataFrame em um arquivo json

dirXLSX = "../AT2/Mini-Projeto1/XBOX360/dataframeXBOX360.xlsx"  # define o caminho do arquivo xlsx
